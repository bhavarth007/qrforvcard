...
DEFAULT_DB = {
    "qrcodes": [
        ...
        },
        {
            ...
            "destinationUrl": "BEGIN:VCARD\r\nVERSION:3.0\r\nN:DHOLARIYA;SHAILESH;;;\r\nFN:SHAILESH DHOLARIYA\r\nORG:Ghanshyam Synthetics / Silken Sonnets\r\nTITLE:SALES HEAD\r\nTEL;TYPE=CELL:+919925933568\r\nEMAIL:shaileshdholariya87@gmail.com\r\nitem1.ADR;TYPE=WORK:;;PLOT NO. C1B-4308/8, ROAD NO. 43-B, SACHIN GIDC;SURAT;GUJARAT;394230;INDIA\r\nitem1.X-ABLabel:Address-1\r\nitem2.ADR;TYPE=HOME:;;Plot No. A1/8, Road No. 9, Hojiwala Ind. Estate;Sachin, Surat;Gujarat;394230;India\r\nitem2.X-ABLabel:Address-2\r\nitem3.URL:https://wa.me/919925933568\r\nitem3.X-ABLabel:WhatsApp\r\nX-SOCIALPROFILE;TYPE=whatsapp:https://wa.me/919925933568\r\nEND:VCARD",
            "active": True,
        ...
        },
        {
            ...
            "destinationUrl": "BEGIN:VCARD\r\nVERSION:3.0\r\nN:HIDAD;MILAN;;;\r\nFN:MILAN HIDAD\r\nORG:Ghanshyam Synthetics / Silken Sonnets\r\nTITLE:MANAGER\r\nTEL;TYPE=CELL:+916355979500\r\nEMAIL:milanhidad3215@gmail.com\r\nitem1.ADR;TYPE=WORK:;;PLOT NO. C1B-4308/8, ROAD NO. 43-B, SACHIN GIDC;SURAT;GUJARAT;394230;INDIA\r\nitem1.X-ABLabel:Address-1\r\nitem2.ADR;TYPE=HOME:;;Plot No. A1/8, Road No. 9, Hojiwala Ind. Estate;Sachin, Surat;Gujarat;394230;India\r\nitem2.X-ABLabel:Address-2\r\nitem3.URL:https://wa.me/916355979500\r\nitem3.X-ABLabel:WhatsApp\r\nX-SOCIALPROFILE;TYPE=whatsapp:https://wa.me/916355979500\r\nEND:VCARD",
            "active": True,
            "createdAt": "2026-08-26T13:00:00.000000",
            "updatedAt": "2026-08-26T13:00:00.000000",
            "options": {
...
def parse_vcard_data(raw_vcard: str) -> Dict[str, str]:
    ...
    if not wa:
        wa = re.search(r'(?:item\d+\.)?URL:(.*wa\.me.*)', raw_vcard, re.IGNORECASE)
    if wa:
